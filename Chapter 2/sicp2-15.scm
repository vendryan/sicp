...
; Test
; Hmmm... why different?
(define r1 (make-center-percent 35 10))
(define r2 (make-center-percent 45 10))
...
; In my opinion Eva Lu Ator is right, because if we
; computed number with error again, it will deviate
; even further
