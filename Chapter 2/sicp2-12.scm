...
; Test
(define test (make-center-percent -300 20))
(define test2 (make-center-percent 35 10))
(define test3 (make-center-percent 50 0))
(print-interval test)
(print (percent test)) ; Should be 20
(print-interval test2)
(print (percent test2)) ; Should be 10
(print-interval test3)
(print (percent test3)) ; Should be 0
